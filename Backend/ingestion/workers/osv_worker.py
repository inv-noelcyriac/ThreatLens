...
#     - Full Sync: Downloads all.zip snapshot on cold start.
#     - Incremental Sync: Streams modified_id.csv to fetch ONLY modified records.
#     """
...
#         """Downloads full all.zip and performs complete baseline import."""
#         logger.info(
#             "[OSV] Initializing Full Baseline Sync via all.zip snapshot..."
#         )
...
#                             )
#                             self.save_advisory(
#                                 external_id=external_id, raw_payload=advisory
#                             )
#                             total_processed += 1
...
#                                 logger.info(
#                                     f"[OSV] Full Sync progress: {index}/{total_files} advisories saved."
#                                 )
...
#     ) -> tuple[int, datetime]:
#         """Streams modified_id.csv and fetches modified records since last_checkpoint."""
#         logger.info(
...
#             # 2. Safety Cap: Batch limit to avoid holding worker loops forever
...
#                     logger.info(f"[OSV] Incremental sync progress: {total_processed} items processed...")
